...
\usepackage{xurl}   % let long URLs break across lines (no margin overflow)
...
0.10) and significant rather than large; our claims rest on the calibrated null
and the redundant-control comparison, not on effect magnitude. The gloss-based
typology is a proxy, corroborated by the radical at 74.5 percent but not by a
native-speaker gold
